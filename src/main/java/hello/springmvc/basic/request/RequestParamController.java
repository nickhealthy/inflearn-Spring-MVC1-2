...
public class RequestParamController {
     ...
     * <p>
     * 주의! /request-param-required int age -> null을 int에 입력하는 것은 불가능, 따라서 Integer 변경해야 함(또는 다음에 나오는
     * defaultValue 사용)
     */
    @ResponseBody
     ...
     *
     * 파라미터와 프로퍼티의 타입이 맞지 않으면 BindException이 발생한다.
     */
    @ResponseBody
     ...
     * argument resolver 로 지정해둔 타입 외 = @ModelAttribute 적용 */
    @ResponseBody
